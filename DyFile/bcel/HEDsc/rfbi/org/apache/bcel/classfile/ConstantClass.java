...
public class ConstantClass
{
 public static void testaccept(org.apache.bcel.classfile.Visitor a) {
        ((org.apache.bcel.classfile.ConstantClass) DeSerializedState.getInstance().getDeserializedObj()).accept(a);
 }

 public static void testdump(java.io.DataOutputStream a) throws java.io.IOException {
        ((org.apache.bcel.classfile.ConstantClass) DeSerializedState.getInstance().getDeserializedObj()).dump(a);
 }
